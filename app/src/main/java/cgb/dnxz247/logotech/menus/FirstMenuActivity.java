...
public class FirstMenuActivity extends AppCompatActivity implements MenuActivity{
    ...
    public void goToGame(String mode) {
        Utils.goToActivityExtra(this, FirstMenuActivity.this, FirstGameActivity.class, mode);
    }

    public void backToMain() {
        Utils.backToMain(this, FirstMenuActivity.this);
    }
}